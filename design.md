...
The passive radiator tunes the cabinet to 30.5hz (versus ~61hz if it was simply sealed). This allows the subwoofer to extend deeper for a better sound. Since the passive radiator also contains a cone and suspension, it is able to offload work from the subwoofer. Rather than having the subwoofer itself produce all the bass, the passive radiator becomes pneumatically coupled to the subwoofer in the bass range. This coupling gets stronger the lower the frequency goes, to the point where at the tuning frequency, the subwoofer itself barely moves, while the passive radiator is producing all the bass. Above the tuning frequency, they can work together, producing more bass total than either one could produce on their own.
